          ...
          <ScrollView className="space-y-4">
            ...
            <View>
              ...
              <Text>
                ...
                their foot. You must finish your hand before picking up your
                foot.
              </Text>
            </View>
            <View>
            ...
            <View>
              ...
              <Text>
                A meld of 7+ cards is called a book. Clean books (no wilds)
                score more points than dirty books (with wilds).
              </Text>
            </View>
            <View>
